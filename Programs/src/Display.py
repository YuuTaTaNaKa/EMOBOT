...
#     # 画像のパスを修正
#     image_path = os.path.join("C:\\EMOBOT\\Programs\\img\\boy_Default.jpg")
#     # 画像を読み込む
#     boy_Default_image = pygame.image.load(image_path)
#     # 画像のサイズを取得してウィンドウサイズを設定
#     WIDTH, HEIGHT = boy_Default_image.get_width(), boy_Default_image.get_height()
#     screen = pygame.display.set_mode((WIDTH, HEIGHT),pygame.FULLSCREEN)  # ウィンドウの作成
#     # フルスクリーンの解像度を取得
#     screen_width, screen_height = screen.get_size()
#     # 画像をフルスクリーンのサイズにリサイズ
#     boy_Default_image = pygame.transform.scale(boy_Default_image, (screen_width, screen_height))
#     # ウィンドウタイトル
#     pygame.display.set_caption("Pygame 画面出力例")  
...
#             # girl_Default_image = pygame.transform.scale(girl_Default_image, (screen_width, screen_height))
